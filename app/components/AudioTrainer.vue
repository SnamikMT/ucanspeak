...
.kicker{
  margin-top:31px; margin-bottom:0;
...
.grid{
  margin-top:50px;
  display:grid;
  grid-template-columns:654px 318px 318px;
  gap:20px;
...
.stickyText{
  position:relative;
  font-family:Inter,sans-serif; font-weight:500;
  font-size:16px; line-height:20px; /* фикс из макета */
  letter-spacing:-0.02em; color:#2C2C2C;
}

.tv{
  position:relative; z-index:0;
  display:inline; line-height:inherit; vertical-align:baseline;
}
...
.cta{
  width:370px; height:46px; background:#FFD249; color:#2C2C2C;
...
.feature p{
  margin:0; font-weight:500; font-size:16px; line-height:1.3;
}
...
@media (max-width:640px){
  ...
  .kStart{
    display:block;    /* ← первая строка */
  }
  .kRest{
    display:block;    /* ← вторая строка */
  }

  .grid{ grid-template-columns:1fr; gap:16px; margin-top:70px; }

  .video{ width:100%; }
  .poster{ width:100%; height:180px; border-radius:14px; }

  .sticky{
    left:16px; top:-30px; width:300px; padding:10px 12px;
    transform:rotate(5.26deg);
    height: 62px;
  }
  ...
  .info{
    width:100%; height:157px; border-radius:14px;
    padding:30px 10px 30px 30px; justify-content:center;
  }
  .info h3{ font-size:22px; }
  .info p{ font-size:14px; width:90%; }

  .ctaRow{ padding:20px 0 50px; }
  .cta{
    width:340px; height:auto;
    padding:5px 5px 5px 15px; font-size:14px; gap:10px;
    line-height:130%; letter-spacing:-.03em;
  }

  .features{
    grid-template-columns:1fr; gap:12px; margin-top:16px;
  }
